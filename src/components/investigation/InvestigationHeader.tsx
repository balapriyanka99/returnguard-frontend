...
export function InvestigationHeader({ data, onBack }: { data: ReturnDetailResponse; onBack: () => void }) {
  ...
  return <header className="investigation-header">
    <div className="case-topline"><button className="case-back" onClick={onBack}><ArrowLeft size={16}/>Back to investigations</button><SourceBadge sourceType={data.source_type}/></div>
