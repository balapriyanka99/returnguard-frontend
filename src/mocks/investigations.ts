...
const mockMissingItem: ReturnDetailResponse = {
  ...
  return: { order_id: 2190, order_item_id: 3102, user_id: 2044, product_id: 18920, reason: 'Item missing from package', status: 'Under review', requested_at: '2025-05-13T14:10:00Z', assessment_at: '2025-05-14T16:30:00Z', sale_price: 349, product_name: 'Sony WH-1000XM5 Wireless Headphones', product_category: 'Audio', customer_name: 'Customer 2044' },
  ...
  product: null,
  inspection: { available: true, item_present: false, condition: 'package received', expected_weight_kg: 0.25, actual_weight_kg: 0.04, weight_delta_kg: -0.21, weight_ratio: 0.16, serial_comparison_performed: false, serial_mismatch: null, accessory_comparison_performed: false, missing_accessories: [], inspected_at: '2025-05-14T16:25:00Z' },
  evidence: null,
  ...
  risk: null, decision: null, vision: null,
  limitations: ['Visual assessment has not been performed', 'No customer-uploaded evidence is available']
};

const mockNormalCase: ReturnDetailResponse = {
  return_id: 'RTN-L01-003', source_type: 'controlled',
  return: { order_id: 5410, order_item_id: 7921, user_id: 4892, product_id: 11044, reason: 'Size issue / does not fit', status: 'Requested', requested_at: '2025-05-15T08:00:00Z', assessment_at: '2025-05-15T08:05:00Z', sale_price: 139, product_name: 'Nike Air Max Running Shoes (Size 10)', product_category: 'Footwear', customer_name: 'Customer 4892' },
  ...
  risk: null, decision: null, vision: null,
  limitations: ['Visual assessment has not been performed']
};
...
export const mockAssessmentHistoryMap: Record<string, AssessmentHistoryResponse> = {
  ...
  'RTN-S06-001': { items: [{ assessment_id: 'ASM-S06', assessment_at: '2025-05-14T16:30:00Z', stage: 'inspection', stage_label: 'Inspection', risk: null, decision: null }] },
  'RTN-L01-003': { items: [{ assessment_id: 'ASM-L01', assessment_at: '2025-05-15T08:05:00Z', stage: 'inspection', stage_label: 'Inspection', risk: null, decision: null }] }
};
...
export const mockTimelineEventsMap: Record<string, TimelineEvent[]> = {
  ...
  'RTN-S06-001': [{ id: 'EVT-S06-1', title: 'Warehouse inspection completed', timestamp: '2025-05-14T16:25:00Z', facts: ['Package received and item recorded as not present', 'Weight captured: 0.040 kg'], source_indicator: 'Warehouse Inspection', severity: 'normal' }],
